...
//            System.out.println("END Print current massive");
           // System.out.println("PPP "+ comandsString[0]);
            ...
            ArrayList<String> comandsString_BUFFER = new ArrayList<String>();
            for(int i = 0; i < comandsString.length; i++){
            ...
            for(int i = 0; i < comandsString.length; i++){
                ...
                if (comandsString[i].indexOf("controls_ifelse") != -1){
                    ...
                    buf_str += comandsString[i + u];
                    i += u;
                    comandsString_BUFFER.add(i,  buf_str.split("IF0")[1].split(",\"DO0\":")[0] );
                    comandsString_BUFFER.add(i,  "DO");
                    comandsString_BUFFER.add( i,   buf_str.split("IF0")[1].split(",\"DO0\":")[1].split("\"ELSE\"")[0] );
                    ...
                    if (comandsString[i].indexOf("initialPosition") != -1){
                        ...
                        comandsString_BUFFER.add(i,buf_str);
                    }
                    else {
            ...
            if(thereAreAttachments){
                ...
                String[] dblArray = new String[comandsString_BUFFER.size()];
                dblArray = comandsString_BUFFER.toArray(dblArray);
